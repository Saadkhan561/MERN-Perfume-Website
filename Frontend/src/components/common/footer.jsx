...
const Footer = () => {
  ...
  return (
    <div className={router.query.payment ? "opacity-50 duration-200 bg-slate-800 flex justify-center text-slate-300 mt-20":"bg-gray-900 flex justify-center text-slate-300 mt-20"}>
